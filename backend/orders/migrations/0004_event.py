    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtype', models.CharField(blank=True, max_length=255, null=True, verbose_name='subtype')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='events', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
                'verbose_name': 'event',
